...
author: "Rafael Farias Varona (DNI: 72546633-X), Sara García Bustos (DNI: 05439198-C), Manuel Gonzales Arambúru (DNI: 00000000-X) y Miguel Salmerón Vicente (DNI: 02769472-L)"
format:
  revealjs:
    theme: [style.scss]
...
De acuerdo con la Ley 45/2007, de Desarrollo Sostenible del Medio Rural, un municipio se clasifica como [**rural**]{style="color:red;"} si tiene [**menos de 30.000 habitantes**]{style="color:red;"} y una densidad poblacional [**menor de 100 habitantes/km2**]{style="color:red;"}.

Información sobre la superficie de los municipios: <https://ssweb.seap.minhap.es/REL/frontend/inicio/index>
